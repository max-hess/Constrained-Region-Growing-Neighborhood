...
# Generate normals
normals_face1 = np.tile([0, 0, 1], (n // 2, 1))  # Normals pointing up for face1
normals_face2 = np.tile([1, 0, 0], (n // 2, 1))  # Normals pointing in x-direction for face2
...
constraint_neighbors = constraint_region_growing(
    seeds, kk, points, radius, normals, orientation_tolerance
)
